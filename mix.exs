defmodule Scry.Engine.RedisTimeSeries.MixProject do
  use Mix.Project
  ...
  def project do
    [
      app: :scry_engine_redistimeseries,
      version: @version,
      elixir: "~> 1.19",
      ...
      package: package(),
      name: "Scry.Engine.RedisTimeSeries",
      docs: docs(),
      aliases: aliases(),
  ...
  defp description do
    "A real Scry.Core.EngineBehaviour implementation over RedisTimeSeries, translating a flat " <>
      "time-range WHERE into TS.RANGE's own native from/to/FILTER_BY_VALUE bounds, over redix."
  end

  defp package do
    [
      licenses: ["MIT"],
      links: %{"GitHub" => "https://github.com/joetjen/scry_engine_redistimeseries"},
  ...
  defp docs do
    [
      main: "readme",
      source_url: "https://github.com/joetjen/scry_engine_redistimeseries",
